...
#import Clase_Imagen
#x = Imagen()
#data=Imagen.load_dicoms("./EGGS_DIANA/datas/data_train/x_train")
#datainf=Imagen.info_dicom("./EGGS_DIANA/",1)
#datainf=Imagen.plot_imagenes("./EGGS_DIANA/datas/data_train/y_train")
